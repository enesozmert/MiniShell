...
{
	command[0] = (t_command){"builtin", "echo", "3,5,8,10", NULL, echo_start, 0};
	command[1] = (t_command){"builtin", "cd", "5,8,11", NULL, cd_start, 0};
	command[2] = (t_command){"builtin", "pwd", "", NULL, pwd_start, 0};
	command[3] = (t_command){"builtin", "export", "5,6,7,8,9", NULL, export_start, 0};
