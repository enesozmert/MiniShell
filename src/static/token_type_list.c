...
void	token_type_list(t_token_type *token_type)
{
	...
	token_type[7] = (t_token_type){"valid_identifier", token_type_is_valid_identifier};
	token_type[8] = (t_token_type){"invalid_identifier", token_type_is_invalid_identifier};
	token_type[9] = (t_token_type){"key", token_type_is_key};
	token_type[10] = (t_token_type){"value", token_type_is_value};
	token_type[11] = (t_token_type){"string", token_type_is_string};
	token_type[12] = (t_token_type){"arg", token_type_is_arg};
	token_type[13] = (t_token_type){NULL, NULL};
}